...
console.log(yetAnotherThing, "You, well, um, ahem, ah, er, suck, ah, a, gerrr, ahhh, lot, um, Man. Um, er, got, of penis and er, ah, ah, um, that, ah, anal, er, boy?!?");

const blueLink = document.querySelector(".line-1a");
blueLink.addEventListener("click", changeOpacity);

function changeOpacity() {
    document.body.innerText = "NICE WORK, um, Old, um, CALVINO, er, Asshole, well, grrrr, ahem, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
