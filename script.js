...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, ah, errr, laaaah, errr, ummm, ehhh, duhhh, errrr, duhhh, aggg, errrrr, suck, gaaaa, ah, errr, mmm, ahhhh, grrr, errr, uhhhh, er, ahhh, ahhhh, hmmm, er, errr,  grrr, ahhh, gerrr, kkkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
);
...
function changeOpacity() {
  document.body.innerText =
    "NICE WORK, um, Old, um, CALVINO, er, ahhh, Asshole, err, arrrr, well, ahh, grrrr, ahhh, errrrr, um..., ahem, jahhh, errr, well, uhhhh, kkkkkiiihh, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
