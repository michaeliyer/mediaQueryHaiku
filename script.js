...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, ah, laaaah, suck, ah, ahhhh, er, hmmm, ahhh, gerrr, kkkk, grrrr, ahh, well, lot, um, Man. Um, er, got, er, of penis and er, ah, ah, um, that, ah, anal, er, boy?!?"
);
...
function changeOpacity() {
  document.body.innerText =
    "NICE WORK, um, Old, um, CALVINO, er, Asshole, err, well, grrrr, um..., ahem, well, uhhhh, kkkkkiiihh, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
