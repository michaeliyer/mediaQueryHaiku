...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, suck, ah, ahhhh, er, hmmm, gerrr, ahh, well, lot, um, Man. Um, er, got, er, of penis and er, ah, ah, um, that, ah, anal, er, boy?!?"
);
...
function changeOpacity() {
  document.body.innerText =
    "NICE WORK, um, Old, um, CALVINO, er, Asshole, well, grrrr, ahem, well, kkkkkiiihh, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
