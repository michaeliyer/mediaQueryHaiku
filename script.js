...
// console.log(
//   yetAnotherThing,
//   "You, um, errr, well, um, ahem, ah, er, ah, err, laaaah, err, umm, ehh, ahh, duhh, err, duhh, agg, err, suck, gaaaa, grr, ah, err, mm, ahh, grr, err, uhhh, er, ahh, ahh, hmm, er, err,  grrr, ahhh, gerr, kkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
// );
...
//     "NICE WORK, um, Old, um, CALVINO, er, ahh, AssholE, err, arr, well, ahh, grrr, ahh, errr, um..., ahem, jahh, errr, well, uhhh, kkkiiihh, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
...
console.log(
  yetAnotherThing,
  "You, uh, well, um, ahem, ah, er, ah, err, laaaah, err, umm, ehh, ahh, duhh, err, duhh, agg, err, suck, gaaaa, grr, ah, err, mm, ahh, grr, err, uhhh, er, ahh, ahh, hmm, er, err,  grrr, ahhh, gerr, kkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
);
