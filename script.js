...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, ah, err, laaaah, errr, umm, ehhh, ahh, duhh, err, duhh, agg, err, suck, gaa, grr, ah, err, mmm, ahh, grr, err, uhhh, er, ahhh, ahhhh, hmm, er, errr,  grrr, ahhh, gerrr, kkkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
);
