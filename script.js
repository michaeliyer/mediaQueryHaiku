...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, ah, err, laaaah, err, umm, ehh, ahh, duhh, err, duhh, agg, err, suck, gaa, grr, ah, err, mm, ahh, grr, err, uhhh, er, ahhh, ahh, hmm, er, errr,  grrr, ahhh, gerrr, kkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
);
