...
console.log(
  yetAnotherThing,
  "You, well, um, ahem, ah, er, ah, err, laah, errr, umm, ehhh, ahh, duhh, err, duhh, agg, err, suck, gaa, grr, ah, errr, mmm, ahhh, grrr, err, uhhhh, er, ahhh, ahhhh, hmm, er, errr,  grrr, ahhh, gerrr, kkkk, jaaa, grrrr, errr, ahh, well, lot, um, Man. Um, er, got, er, of penis, grrr, and er, ah, ah, um, that, errr, ah, anal, er, boy?!?"
);
...
function changeOpacity() {
  document.body.innerText =
    "NICE WORK, um, Old, um, CALVINO, er, ahh, Asshole, err, arr, well, ahh, grrr, ahhh, errr, um..., ahem, jahhh, errr, well, uhhhh, kkvvsdkkkiiihh, gaaaq, um, er, ah, er, that, er, gaa, ah, you, ah, are, well...see!";
