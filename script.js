...
console.log(yetAnotherThing, "You, um, suck, ah, a lot, um, Man. Um, Got, um, that, anal, er, boy?!?");

const blueLink = document.querySelector(".line-1a");
blueLink.addEventListener("click", changeOpacity);

function changeOpacity() {
    document.body.innerText = "NICE WORK Old CALVINO, Asshole, er, that, ah, you are!";
